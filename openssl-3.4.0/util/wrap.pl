...
BEGIN {
    ...
    require '/home/pablo/RubymineProjects/evo-gw/openssl-3.4.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/pablo/RubymineProjects/evo-gw/openssl-3.4.0/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/home/pablo/RubymineProjects/evo-gw/openssl-3.4.0/test/default-and-jitter.cnf';
    shift;
